...
const Login = () => {
    ...
    const backgroundImage = {
        backgroundImage: 'url(https://skct.edu.in/wp-content/uploads/2024/04/SKCT-College-Campus-12.jpg)', // Replace with your image path
        ...
        <>
            {!user?._id ? (
                ...
                >
                    ...
                    <section className="z-0 w-[65%] justify-self-center rounded-lg bg-slate-100 opacity-80 hover:opacity-100 focus:opacity-100 duration-200 dark:bg-slate-700 sm:w-[min(50%,360px)] md:w-[min(40%,360px)] xl:w-[min(23%,360px)]">
                        <form
                        ...
                        >
                            ...
                            <section className="rounded-b-lg px-4 pb-4 dark:border-x-[1.5px] dark:border-b-[1.5px] dark:border-solid dark:border-violet-900">
                                {userType ? (
                                    ...
                                    <p className="w-full bg-violet-300 dark:bg-violet-950/90 duration-200 rounded p-4 my-12 text-center">
                                        Select User Type
                                    </p>
                                )}
