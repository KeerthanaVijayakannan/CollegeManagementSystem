...
const StaffForm = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:5050/staff/register', {
                name,
                email,
                password,
                dept,
    ...
    const appStyle = {
        ...
        alignItems: 'center',
        minHeight: '80vh', // Reduced background size
        backgroundColor: '#f0f0f0', // Light background color
        padding: '20px', // Added padding to create space around the container
    };
    ...
    const containerStyle = {
        ...
        maxWidth: '400px', // Slightly reduced width
        width: '100%',
    };
